...
---@field public startvertex number @The index of the first vertex to replace.
...
function love_graphics.flushBatch() end
...
---@field public [3] number @The u texture coordinate of the vertex. Texture coordinates are normally in the range of [0, 1], but can be greater or less (see WrapMode.)
---@field public [4] number @The v texture coordinate of the vertex. Texture coordinates are normally in the range of [0, 1], but can be greater or less (see WrapMode.)
---@field public [5] number @The red component of the vertex color.
---@field public [6] number @The green component of the vertex color.
---@field public [7] number @The blue component of the vertex color.
---@field public [8] number @The alpha component of the vertex color.
...
function love_window.restore() end
